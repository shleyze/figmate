...
function _getConfig() {
  _getConfig = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(FUNC_CONFIG) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            return _context.abrupt("return", (0, _merge["default"])(DEFAULT_CONFIG, USER_PACKAGE_CONFIG[PACKAGE_NAME], USER_CONFIG, FUNC_CONFIG));
...
function _getFigmaFile() {
  _getFigmaFile = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(config) {
    var tempFolder, boards, FIGMA_TEMP_FILE, token, fileId, FigmaAPI, loading, FILE;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            tempFolder = config.tempFolder, boards = config.boards;
          ...
          case 11:
            ...
            throw new Error(_index.messages.boardsAreEmpty);
